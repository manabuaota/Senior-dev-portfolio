...
const projects: Project[] = [
  ...
  },
  {
    ...
    name: 'Layla',
    full: false,
    description: ' mobile app available on iOS and Android platforms.',
    image: { src: laylaIos },
  },
  {
    href: '/apps/layla-android',
    name: 'Layla Android',
    full: false,
    description: ' Android version of the Layla mobile application.',
    image: { src: laylaAndroid },
  },
  {
    href: '/apps/sam-smart-assistant',
    name: 'SAM Smart Assistant Mate',
    full: false,
    description: ' Android mobile application for smart assistant functionality.',
    image: { src: samSmartAssistant },
  },
  {
    href: '/apps/discord-bot-website',
    name: 'Discord Bot Website',
    full: false,
    description: ' Landing page template for promoting a custom Discord bot, inspired by modern bot marketing sites.',
    image: { src: discordBotWebsite },
  },
  {
    href: '/apps/discord-music-bot',
    name: 'Discord Music Bot',
    full: false,
    description: ' Marketing site for a free Discord music bot, similar to Beatra with a bold hero and feature sections.',
    image: { src: discordMusicBot },
  },
  {
    href: '/apps/realself-scraping',
    name: 'RealSelf.com Scraper',
    full: false,
    description: ' Advanced web scraping solution that bypasses PerimeterX and HSTS security to extract comprehensive professional data.',
    image: { src: realselfScraping },
  },
  {
    href: '/apps/walmart-scraping',
    name: 'Walmart Data Scraper',
    full: false,
    description: ' Sophisticated scraper that overcomes IP blocking, captchas, and bot detection to extract complete product data.',
    image: { src: walmartScraping },
  },
];
