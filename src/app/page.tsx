...
const content: contentSection[] = [
  ...
  },
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          Some of <span className="text-my_work_yellow">my work</span> as a full stack <span className="text-my_work_yellow">software</span> Engineer
        </div>
      ),
    },
    mainContent: <MyWork />,
          ...
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              <h1 className="font-display text-5xl font-medium tracking-tight [text-wrap:balance] sm:text-6xl">
                Harry Cartwright<span className="wave">👋</span>
              </h1>
              ...
              <p className="max-w-3xl">28 yo software engineer with a B.S. in Computer Science and Technology with experience in Front-End and Back-End and Scraping and Discord Bots and AI Automatioin technologies.</p>
            </FadeIn>
